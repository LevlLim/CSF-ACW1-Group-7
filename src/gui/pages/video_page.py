"""Video page: shows the Embed and Extract & Verify panels side by side,
mirroring audio_page.py's two-column layout."""

from __future__ import annotations

import customtkinter as ctk

from ..panels.video_embed_panel import VideoEmbedPanel
from ..panels.video_verify_panel import VideoVerifyPanel


class VideoPage(ctk.CTkFrame):  # type: ignore[misc]  # customtkinter ships without type stubs
    def __init__(self, master: ctk.CTkBaseClass) -> None:
        ...
        embed_panel = VideoEmbedPanel(scroll_area)
        embed_panel.grid(row=0, column=0, sticky="new", padx=(0, 12))

        verify_panel = VideoVerifyPanel(scroll_area)
